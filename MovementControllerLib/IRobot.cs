...
namespace DriverLib
{
    public interface IRobot //lol like the movie
    {
        ...
        /// <param name="objectDirection">Direction to detect object in</param>
        /// <param name="distanceFromObject">The distance from the object for which to stop moving</param>
        public Task MoveInDirectionUntilSense(Direction movementDir, Direction objectDirection, int distanceFromObject);
